  ...
  const planos = [
    {
      ...
      price: 'R$27',
      bullets: [
        <React.Fragment key="1">Como construir, preservar, multiplicar e perpetuar patrimônio <strong className="text-text-main font-medium">(O Sistema Completo da Ordem)</strong></React.Fragment>,
        ...
        <React.Fragment key="3">Entrega imediata · Acesso vitalício</React.Fragment>
      ]
    },
    {
      id: 'segundo',
      title: 'Segundo Grau',
      subtitle: 'Como Fazer e Investir Como os Maçons + O Código do Poder',
      tag: 'MAIS ESCOLHIDO',
    ...
    },
    {
      ...
      subtitle: 'Coleção Completa: Renda + Poder + Imóveis',
      tag: 'MELHOR VALOR',
      ...
      <section id="planos" className="bg-[#050505] py-24 px-6 border-t border-border-subtle/30 scroll-mt-10 relative">
        <div className="max-w-4xl mx-auto relative z-10 pl-2">
          ...
          <FadeIn delay={0.4} className="mt-12 text-center">
            <button className="w-full shadow-[0_0_40px_rgba(201,168,76,0.15)] md:w-auto px-12 py-5 bg-accent-gold hover:bg-accent-gold-hover text-primary transition-all tracking-[0.1em] uppercase text-sm font-bold rounded-sm">
            ...
            <div className="flex justify-center mt-6">
               <div className="flex items-center gap-6 text-text-faint text-xs tracking-widest uppercase">
                  <span className="flex items-center gap-2"><KeyRound size={14}/> PIX ou Cartão</span>
                  <span className="flex items-center gap-2"><FileLock2 size={14}/> Conteúdo Seguro</span>
               </div>
            </div>
          </FadeIn>
        </div>
